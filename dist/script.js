...
var checkNumInputs = function checkNumInputs(selector) {
  var numInpust = document.querySelectorAll(selector);
  numInpust.forEach(function (item) {
...
/* harmony import */ var core_js_stable_dom_collections__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! core-js/stable/dom-collections */ "./node_modules/core-js/stable/dom-collections/index.js");
/* harmony import */ var core_js_stable_dom_collections__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(core_js_stable_dom_collections__WEBPACK_IMPORTED_MODULE_5__);
...
var forms = function forms(state) {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_6__["default"])('input[name="user_phone"]'); // phoneInputs.forEach(item => {
